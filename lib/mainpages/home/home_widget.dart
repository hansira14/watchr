...
class _HomeWidgetState extends State<HomeWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    final widescreenPieChartColorsList = [
      FlutterFlowTheme.of(context).accent2,
      FlutterFlowTheme.of(context).secondary,
      FlutterFlowTheme.of(context).tertiary,
      FlutterFlowTheme.of(context).alternate
                                                                        ...
                                                                        builder:
                                                                          ...
                                                                          return Container(
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              mainAxisSize: MainAxisSize.max,
                                                                              children: [
                                                                                if (MediaQuery.sizeOf(context).width < 1920.0)
                                                                                  Expanded(
                                                                                    child: Padding(
                                                                                      ...
                                                                                      child: SizedBox(
                                                                                        ...
                                                                                        child: Stack(
                                                                                          children: [
                                                                                            FlutterFlowPieChart(
                                                                                              data: FFPieChartData(
                                                                                                values: functions.partylistdata(containerVoterRecordList.toList()).map((e) => e.partycount).toList(),
                                                                                                colors: barPieChartColorsList2,
                                                                                                radius: [20.0],
                                                                                              ),
                                                                                            ...
                                                                                            Align(
                                                                                              ...
                                                                                              child: FlutterFlowChartLegendWidget(
                                                                                                entries: functions
                                                                                                    .partylistdata(containerVoterRecordList.toList())
                                                                                                    .map((e) => e.partylistname)
                                                                                                    .toList()
                                                                                                    .asMap()
                                                                                                    .entries
                                                                                                    .map(
                                                                                                      (label) => LegendEntry(
                                                                                                        barPieChartColorsList2[label.key % barPieChartColorsList2.length],
                                                                                                        label.value,
                                                                                                      ),
                                                                                                    )
                                                                                                    .toList(),
                                                                                        ...
                                                                                        child: Stack(
                                                                                          children: [
                                                                                            FlutterFlowPieChart(
                                                                                              data: FFPieChartData(
                                                                                                values: functions.partylistdata(containerVoterRecordList.toList()).map((e) => e.partycount).toList(),
                                                                                                colors: widescreenPieChartColorsList,
                                                                                                radius: [20.0],
                                                                                              ),
                                                                                            ...
                                                                                            Align(
                                                                                              ...
                                                                                              child: FlutterFlowChartLegendWidget(
                                                                                                entries: functions
                                                                                                    ...
                                                                                                    .map(
                                                                                                      (label) => LegendEntry(
                                                                                                        widescreenPieChartColorsList[label.key % widescreenPieChartColorsList.length],
                                                                                                        label.value,
                                                                                                      ),
                                                                                                    )
                                                                                                    .toList(),
